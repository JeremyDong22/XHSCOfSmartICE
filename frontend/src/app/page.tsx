...
// Version: 3.5 - Separated Data Laundry into its own route for URL persistence
// Changes: Removed tab state, Data Laundry now at /data-laundry route
// Previous: Fixed footer spacing to prevent overlap with content
